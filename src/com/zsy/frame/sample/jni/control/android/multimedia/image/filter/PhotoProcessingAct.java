package com.zsy.frame.sample.jni.control.android.multimedia.image.filter;
...
import com.zsy.frame.sample.jni.control.android.multimedia.image.filter.utils.BitmapUtils;
import com.zsy.frame.sample.jni.control.android.multimedia.image.filter.utils.FileUtils;
import com.zsy.frame.sample.jni.control.android.multimedia.image.filter.utils.MediaUtils;

public class PhotoProcessingAct extends Activity implements OnLongClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_android_multimedia_image_filter_photoprocessing);
		...
		mFilterListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
				sFilterTask = new FilterTask(PhotoProcessingAct.this);
		...
		mEditListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			@Override
			public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
				sEditActionTask = new EditActionTask(PhotoProcessingAct.this);
	...
	private void showFilterList() {
		if (mIsFilterListShowing) { return; }

		hideEditList();

		TranslateAnimation translateAnimation = new TranslateAnimation(TranslateAnimation.RELATIVE_TO_SELF, 1.0f, TranslateAnimation.RELATIVE_TO_SELF, 0.0f, TranslateAnimation.RELATIVE_TO_SELF, 0.0f, TranslateAnimation.RELATIVE_TO_SELF, 0.0f);
	...
	private void hideFilterList() {
		...
		TranslateAnimation translateAnimation = new TranslateAnimation(TranslateAnimation.RELATIVE_TO_SELF, 0.0f, TranslateAnimation.RELATIVE_TO_SELF, 1.0f, TranslateAnimation.RELATIVE_TO_SELF, 0.0f, TranslateAnimation.RELATIVE_TO_SELF, 0.0f);
		translateAnimation.setInterpolator(new DecelerateInterpolator(2.0f));
	...
	private void hideEditList() {
		...
		TranslateAnimation translateAnimation = new TranslateAnimation(TranslateAnimation.RELATIVE_TO_SELF, 0.0f, TranslateAnimation.RELATIVE_TO_SELF, 0.0f, TranslateAnimation.RELATIVE_TO_SELF, 0.0f, TranslateAnimation.RELATIVE_TO_SELF, 1.0f);
		translateAnimation.setInterpolator(new DecelerateInterpolator(2.0f));
		AlphaAnimation alphaAnimation = new AlphaAnimation(1.0f, 0.0f);
		AnimationSet animation = new AnimationSet(false);
		animation.addAnimation(translateAnimation);
	...
	private static class FilterListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (view == null) {
				view = mInflator.inflate(R.layout.item_android_multimedia_image_filter_photoprocessing_filter_list_item, null);
			}
	...
	private static class EditListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			View view = convertView;
			if (view == null) {
				view = mInflator.inflate(R.layout.item_android_multimedia_image_filter_photoprocessing_edit_list, null);
			}
	...
	private static class FilterTask extends AsyncTask<Integer, Void, Bitmap> {
		WeakReference<PhotoProcessingAct> mActivityRef;

		public FilterTask(PhotoProcessingAct activity) {
			mActivityRef = new WeakReference<PhotoProcessingAct>(activity);
		}

		public void reattachActivity(PhotoProcessingAct activity) {
			mActivityRef = new WeakReference<PhotoProcessingAct>(activity);
		...
		private PhotoProcessingAct getActivity() {
		...
		protected void onPreExecute() {
			PhotoProcessingAct activity = getActivity();
			if (activity != null) {
				activity.showFilterProgressDialog();
	...
	private static class EditActionTask extends AsyncTask<Integer, Void, Bitmap> {
		...
		public EditActionTask(PhotoProcessingAct activity) {
			mActivityRef = new WeakReference<PhotoProcessingAct>(activity);
		}
	...
	private static class SavePhotoTask extends AsyncTask<Void, Void, Void> {
		private WeakReference<PhotoProcessingAct> mActivityRef;
		private String mSavePath;

		public SavePhotoTask(PhotoProcessingAct activity) {
			mActivityRef = new WeakReference<PhotoProcessingAct>(activity);
		}
